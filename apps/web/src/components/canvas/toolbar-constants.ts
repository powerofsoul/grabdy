...
export type ComponentType = keyof typeof COMPONENT_TEMPLATES;

export type ToolbarItem = { type: ComponentType; icon: typeof TableIcon; label: string };

export const PRIMARY_ITEMS: ToolbarItem[] = [
...
export const SECONDARY_ITEMS: ToolbarItem[] = [
