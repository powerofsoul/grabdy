...
export function AccountSetupEmail({ name, setupUrl }: AccountSetupEmailProps) {
  return (
    <EmailLayout preview="Complete your Grabdy account setup">
      ...
      <Text style={sharedStyles.text}>
        You&apos;ve been invited to join Grabdy. Click the button below to set up your password
