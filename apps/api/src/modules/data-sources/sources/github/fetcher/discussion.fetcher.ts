...
import { DISCUSSION_FIELDS, type DiscussionNode } from '../types';
import { buildDiscussionItem } from '../utils';

@Injectable()
export class GitHubDiscussionFetcher {
  private readonly logger = new Logger(GitHubDiscussionFetcher.name);
