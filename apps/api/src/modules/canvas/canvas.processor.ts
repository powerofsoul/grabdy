...
// BullMQ workers lose the original error class. We use this prefix so the
// service can reliably re-throw as NotFoundException.
...
@Processor('canvas-ops', { concurrency: 10 })
